        ...
        <div className="section-inner shadow-sm rounded">
          ...
          <div className="content">
            <p className="text-start">
              ...
              ) and experienced Machine Learning (ML) in the field of artificial
              intelligence (AI), using a variety of programming languages and
              technologies. Alassane also learns quickly with strong
              problem-solving, leadership, management and communication skills,
